    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Bloqlar</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($result->category->parent)
                                                {{ $result->category->parent->name }} <i class="bx bx-dots-horizontal align-middle font-size-16"></i> {{ $result->category->name }}
                                            @else
                                        ...
                                        <td>
                                            <div class="form-check form-switch form-switch-md">
                                                <input data_id="{{ $result->id }}"
                                                       route="{{ route('admin.blog.status.ajax') }}"
                                        ...
                                        <td class="text-end">
                                            <button type="button" data_id="{{ $result->id }}"
                                                    route="{{ route('admin.blog.destroy.ajax') }}"
