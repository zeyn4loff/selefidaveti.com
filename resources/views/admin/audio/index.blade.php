    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Audiolar</h4>
                                        ...
                                        <td>
                                            <div class="form-check form-switch form-switch-md">
                                                <input data_id="{{ $result->id }}"
                                                       route="{{ route('admin.audio.status.ajax') }}"
    ...
    <div class="modal fade" id="filterModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.audio.index') }}" method="get">
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('admin.audio.index') }}" class="btn btn-dark">
